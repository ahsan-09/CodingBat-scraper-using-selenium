...
cars = {'Topic': [] , 'Question': [], 'Description':[] }
t=[]
q=[]
d=[]
...
cars.update({'Topic': t, 'Question': q, 'Description': d})
...
#    print("\n\n")
  #for key, value in products.items():
   # print(key," --> https://codingbat.com"+value)
#url = "https://codingbat.com" + products['Warmup-1']
#page1 = requests.get(url,headers={'user-agent':ua.chrome})

#soup1 = BeautifulSoup(page1.content,'html.parser')
#for link in soup1.find_all("a", href=re.compile("prob")):
#    product.append(link.get('href'))
#url1 = "https://codingbat.com"+product[13]
#print(url1)
...
#for divs in soup2.find_all('div', attrs = {'class':'minh'}):
    #if (divs.p.a):
#    print(divs.p.text)
 #   print(divs.next_sibling.next_element)
  #  print(divs.next_sibling.next_element.next_sibling.next_element)
   # print(divs.next_sibling.next_element.next_sibling.next_element.next_sibling.next_element)
